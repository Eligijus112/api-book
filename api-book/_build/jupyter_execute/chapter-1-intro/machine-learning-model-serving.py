...
# To simulate the ML predictions with different inputs visit the interactive Google Colab notebook: https://colab.research.google.com/github/Eligijus112/api-book/blob/main/api-book/chapter-1-intro/machine-learning-model-serving-colab.ipynb. 
# 
